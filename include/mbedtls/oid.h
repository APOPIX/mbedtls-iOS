...
#define MBEDTLS_OID_RSA_COMPANY                                             \
    MBEDTLS_OID_ISO_MEMBER_BODIES MBEDTLS_OID_COUNTRY_US                    \
        MBEDTLS_OID_ORG_RSA_DATA_SECURITY /* {iso(1) member-body(2) us(840) \
                                             rsadsi(113549)} */
...
#define MBEDTLS_OID_ISO_ITU_US_ORG                                          \
    MBEDTLS_OID_ISO_ITU_COUNTRY MBEDTLS_OID_COUNTRY_US                      \
        MBEDTLS_OID_ORGANIZATION /* {joint-iso-itu-t(2) country(16) us(840) \
                                    organization(1)} */

#define MBEDTLS_OID_ORG_GOV "\x65" /* {gov(101)} */
#define MBEDTLS_OID_GOV                                                   \
    MBEDTLS_OID_ISO_ITU_US_ORG MBEDTLS_OID_ORG_GOV /* {joint-iso-itu-t(2) \
                                                      country(16) us(840) \
                                                      organization(1)     \
                                                      gov(101)} */
...
#define MBEDTLS_OID_NETSCAPE                                                   \
    MBEDTLS_OID_ISO_ITU_US_ORG MBEDTLS_OID_ORG_NETSCAPE /* Netscape OID        \
                                                           {joint-iso-itu-t(2) \
                                                           country(16) us(840) \
                                                           organization(1)     \
                                                           netscape(113730)}   \
...
#define MBEDTLS_OID_ID_CE                                             \
    MBEDTLS_OID_ISO_CCITT_DS "\x1D" /**< id-ce OBJECT IDENTIFIER  ::= \
...
#define MBEDTLS_OID_AT                                               \
    MBEDTLS_OID_ISO_CCITT_DS "\x04" /**< id-at OBJECT IDENTIFIER ::= \
...
#define MBEDTLS_OID_AT_ORGANIZATION                                          \
    MBEDTLS_OID_AT "\x0A" /**< id-at-organizationName AttributeType:= {id-at \
                             10} */
#define MBEDTLS_OID_AT_ORG_UNIT                                             \
    MBEDTLS_OID_AT "\x0B" /**< id-at-organizationalUnitName AttributeType:= \
                             {id-at 11} */
...
#define MBEDTLS_OID_AT_GENERATION_QUALIFIER                              \
    MBEDTLS_OID_AT "\x2C" /**< id-at-generationQualifier AttributeType:= \
                             {id-at 44} */
#define MBEDTLS_OID_AT_UNIQUE_IDENTIFIER                                    \
    MBEDTLS_OID_AT "\x2D" /**< id-at-uniqueIdentifier AttributType:= {id-at \
                             45} */
...
#define MBEDTLS_OID_UID                                                     \
    "\x09\x92\x26\x89\x93\xF2\x2C\x64\x01\x01" /** id-domainComponent       \
                                                  AttributeType:= {itu-t(0) \
                                                  data(9) pss(2342)         \
                                                  ucl(19200300) pilot(100)  \
                                                  pilotAttributeType(1)     \
                                                  uid(1)} */
#define MBEDTLS_OID_DOMAIN_COMPONENT                                        \
    "\x09\x92\x26\x89\x93\xF2\x2C\x64\x01\x19" /** id-domainComponent       \
                                                  AttributeType:= {itu-t(0) \
                                                  data(9) pss(2342)         \
                                                  ucl(19200300) pilot(100)  \
                                                  pilotAttributeType(1)     \
...
#define MBEDTLS_OID_AUTHORITY_KEY_IDENTIFIER                          \
    MBEDTLS_OID_ID_CE "\x23" /**< id-ce-authorityKeyIdentifier OBJECT \
                                IDENTIFIER ::=  { id-ce 35 } */
#define MBEDTLS_OID_SUBJECT_KEY_IDENTIFIER                                     \
    MBEDTLS_OID_ID_CE "\x0E" /**< id-ce-subjectKeyIdentifier OBJECT IDENTIFIER \
                                ::=  { id-ce 14 } */
#define MBEDTLS_OID_KEY_USAGE                                             \
    MBEDTLS_OID_ID_CE "\x0F" /**< id-ce-keyUsage OBJECT IDENTIFIER ::=  { \
                                id-ce 15 } */
#define MBEDTLS_OID_CERTIFICATE_POLICIES                                      \
    MBEDTLS_OID_ID_CE "\x20" /**< id-ce-certificatePolicies OBJECT IDENTIFIER \
                                ::=  { id-ce 32 } */
#define MBEDTLS_OID_POLICY_MAPPINGS                                          \
    MBEDTLS_OID_ID_CE "\x21" /**< id-ce-policyMappings OBJECT IDENTIFIER ::= \
                                { id-ce 33 } */
#define MBEDTLS_OID_SUBJECT_ALT_NAME                                         \
    MBEDTLS_OID_ID_CE "\x11" /**< id-ce-subjectAltName OBJECT IDENTIFIER ::= \
                                { id-ce 17 } */
#define MBEDTLS_OID_ISSUER_ALT_NAME                                            \
    MBEDTLS_OID_ID_CE "\x12" /**< id-ce-issuerAltName OBJECT IDENTIFIER ::=  { \
                                id-ce 18 } */
#define MBEDTLS_OID_SUBJECT_DIRECTORY_ATTRS                               \
    MBEDTLS_OID_ID_CE "\x09" /**< id-ce-subjectDirectoryAttributes OBJECT \
                                IDENTIFIER ::=  { id-ce 9 } */
#define MBEDTLS_OID_BASIC_CONSTRAINTS                                          \
    MBEDTLS_OID_ID_CE "\x13" /**< id-ce-basicConstraints OBJECT IDENTIFIER ::= \
                                { id-ce 19 } */
#define MBEDTLS_OID_NAME_CONSTRAINTS                                          \
    MBEDTLS_OID_ID_CE "\x1E" /**< id-ce-nameConstraints OBJECT IDENTIFIER ::= \
                                { id-ce 30 } */
#define MBEDTLS_OID_POLICY_CONSTRAINTS                                      \
    MBEDTLS_OID_ID_CE "\x24" /**< id-ce-policyConstraints OBJECT IDENTIFIER \
                                ::=  { id-ce 36 } */
#define MBEDTLS_OID_EXTENDED_KEY_USAGE                                      \
    MBEDTLS_OID_ID_CE "\x25" /**< id-ce-extKeyUsage OBJECT IDENTIFIER ::= { \
                                id-ce 37 } */
#define MBEDTLS_OID_CRL_DISTRIBUTION_POINTS                          \
    MBEDTLS_OID_ID_CE "\x1F" /**< id-ce-cRLDistributionPoints OBJECT \
                                IDENTIFIER ::=  { id-ce 31 } */
#define MBEDTLS_OID_INIHIBIT_ANYPOLICY                                         \
    MBEDTLS_OID_ID_CE "\x36" /**< id-ce-inhibitAnyPolicy OBJECT IDENTIFIER ::= \
                                { id-ce 54 } */
#define MBEDTLS_OID_FRESHEST_CRL                                             \
    MBEDTLS_OID_ID_CE "\x2E" /**< id-ce-freshestCRL OBJECT IDENTIFIER ::=  { \
                                id-ce 46 } */
...
#define MBEDTLS_OID_ANY_POLICY                                                 \
    MBEDTLS_OID_CERTIFICATE_POLICIES "\x00" /**< anyPolicy OBJECT IDENTIFIER   \
...
#define MBEDTLS_OID_CRL_NUMBER                                            \
    MBEDTLS_OID_ID_CE "\x14" /**< id-ce-cRLNumber OBJECT IDENTIFIER ::= { \
                                id-ce 20 } */
...
#define MBEDTLS_OID_ANY_EXTENDED_KEY_USAGE                                \
    MBEDTLS_OID_EXTENDED_KEY_USAGE "\x00" /**< anyExtendedKeyUsage OBJECT \
                                             IDENTIFIER ::= {             \
                                             id-ce-extKeyUsage 0 } */
...
#define MBEDTLS_OID_SERVER_AUTH                                               \
    MBEDTLS_OID_KP "\x01" /**< id-kp-serverAuth OBJECT IDENTIFIER ::= { id-kp \
                             1 } */
#define MBEDTLS_OID_CLIENT_AUTH                                               \
    MBEDTLS_OID_KP "\x02" /**< id-kp-clientAuth OBJECT IDENTIFIER ::= { id-kp \
                             2 } */
#define MBEDTLS_OID_CODE_SIGNING                                               \
    MBEDTLS_OID_KP "\x03" /**< id-kp-codeSigning OBJECT IDENTIFIER ::= { id-kp \
                             3 } */
#define MBEDTLS_OID_EMAIL_PROTECTION                                         \
    MBEDTLS_OID_KP "\x04" /**< id-kp-emailProtection OBJECT IDENTIFIER ::= { \
                             id-kp 4 } */
#define MBEDTLS_OID_TIME_STAMPING                                         \
    MBEDTLS_OID_KP "\x08" /**< id-kp-timeStamping OBJECT IDENTIFIER ::= { \
                             id-kp 8 } */
#define MBEDTLS_OID_OCSP_SIGNING                                               \
    MBEDTLS_OID_KP "\x09" /**< id-kp-OCSPSigning OBJECT IDENTIFIER ::= { id-kp \
                             9 } */
...
#define MBEDTLS_OID_ON_HW_MODULE_NAME                                         \
    MBEDTLS_OID_ON "\x04" /**< id-on-hardwareModuleName OBJECT IDENTIFIER ::= \
                             { id-on 4 } */
...
#define MBEDTLS_OID_PKCS                                                      \
    MBEDTLS_OID_RSA_COMPANY "\x01" /**< pkcs OBJECT IDENTIFIER ::= { iso(1)   \
                                      member-body(2) us(840) rsadsi(113549) 1 \
                                      } */
#define MBEDTLS_OID_PKCS1                                                      \
    MBEDTLS_OID_PKCS "\x01" /**< pkcs-1 OBJECT IDENTIFIER ::= { iso(1)         \
                               member-body(2) us(840) rsadsi(113549) pkcs(1) 1 \
                               } */
#define MBEDTLS_OID_PKCS5                                                      \
    MBEDTLS_OID_PKCS "\x05" /**< pkcs-5 OBJECT IDENTIFIER ::= { iso(1)         \
                               member-body(2) us(840) rsadsi(113549) pkcs(1) 5 \
                               } */
#define MBEDTLS_OID_PKCS9                                                      \
    MBEDTLS_OID_PKCS "\x09" /**< pkcs-9 OBJECT IDENTIFIER ::= { iso(1)         \
                               member-body(2) us(840) rsadsi(113549) pkcs(1) 9 \
                               } */
#define MBEDTLS_OID_PKCS12                                                   \
    MBEDTLS_OID_PKCS "\x0c" /**< pkcs-12 OBJECT IDENTIFIER ::= { iso(1)      \
...
#define MBEDTLS_OID_PKCS1_RSA                                                  \
    MBEDTLS_OID_PKCS1 "\x01" /**< rsaEncryption OBJECT IDENTIFIER ::= { pkcs-1 \
                                1 } */
...
#define MBEDTLS_OID_DIGEST_ALG_MD5                                            \
    MBEDTLS_OID_RSA_COMPANY "\x02\x05" /**< id-mbedtls_md5 OBJECT IDENTIFIER  \
                                          ::= { iso(1) member-body(2) us(840) \
                                          rsadsi(113549) digestAlgorithm(2) 5 \
                                          } */
#define MBEDTLS_OID_DIGEST_ALG_SHA1                                                          \
    MBEDTLS_OID_ISO_IDENTIFIED_ORG MBEDTLS_OID_OIW_SECSIG_SHA1 /**<                          \
                                                                  id-mbedtls_sha1            \
                                                                  OBJECT                     \
                                                                  IDENTIFIER                 \
                                                                  ::= { iso(1)               \
...
#define MBEDTLS_OID_DIGEST_ALG_SHA224                                         \
    MBEDTLS_OID_NIST_ALG "\x02\x04" /**< id-sha224 OBJECT IDENTIFIER ::= {    \
                                       joint-iso-itu-t(2) country(16) us(840) \
                                       organization(1) gov(101) csor(3)       \
                                       nistalgorithm(4) hashalgs(2) 4 } */
#define MBEDTLS_OID_DIGEST_ALG_SHA256                                         \
    MBEDTLS_OID_NIST_ALG "\x02\x01" /**< id-mbedtls_sha256 OBJECT IDENTIFIER  \
...
#define MBEDTLS_OID_DIGEST_ALG_SHA384                                         \
    MBEDTLS_OID_NIST_ALG "\x02\x02" /**< id-sha384 OBJECT IDENTIFIER ::= {    \
                                       joint-iso-itu-t(2) country(16) us(840) \
                                       organization(1) gov(101) csor(3)       \
                                       nistalgorithm(4) hashalgs(2) 2 } */

#define MBEDTLS_OID_DIGEST_ALG_SHA512                                         \
    MBEDTLS_OID_NIST_ALG "\x02\x03" /**< id-mbedtls_sha512 OBJECT IDENTIFIER  \
                                       ::= { joint-iso-itu-t(2) country(16)   \
                                       us(840) organization(1) gov(101)       \
...
#define MBEDTLS_OID_DIGEST_ALG_RIPEMD160                                     \
    MBEDTLS_OID_TELETRUST "\x03\x02\x01" /**< id-ripemd160 OBJECT IDENTIFIER \
                                            :: { iso(1)                      \
                                            identified-organization(3)       \
...
#define MBEDTLS_OID_HMAC_SHA1                                                 \
    MBEDTLS_OID_RSA_COMPANY "\x02\x07" /**< id-hmacWithSHA1 OBJECT IDENTIFIER \
                                          ::= { iso(1) member-body(2) us(840) \
                                          rsadsi(113549) digestAlgorithm(2) 7 \
                                          } */

#define MBEDTLS_OID_HMAC_SHA224                                               \
    MBEDTLS_OID_RSA_COMPANY "\x02\x08" /**< id-hmacWithSHA224 OBJECT          \
                                          IDENTIFIER ::= { iso(1)             \
...
#define MBEDTLS_OID_HMAC_SHA256                                               \
    MBEDTLS_OID_RSA_COMPANY "\x02\x09" /**< id-hmacWithSHA256 OBJECT          \
                                          IDENTIFIER ::= { iso(1)             \
                                          member-body(2) us(840)              \
...
#define MBEDTLS_OID_HMAC_SHA384                                                \
    MBEDTLS_OID_RSA_COMPANY "\x02\x0A" /**< id-hmacWithSHA384 OBJECT           \
                                          IDENTIFIER ::= { iso(1)              \
                                          member-body(2) us(840)               \
...
#define MBEDTLS_OID_HMAC_SHA512                                                \
    MBEDTLS_OID_RSA_COMPANY "\x02\x0B" /**< id-hmacWithSHA512 OBJECT           \
                                          IDENTIFIER ::= { iso(1)              \
                                          member-body(2) us(840)               \
...
#define MBEDTLS_OID_DES_CBC                                                    \
    MBEDTLS_OID_ISO_IDENTIFIED_ORG MBEDTLS_OID_OIW_SECSIG_ALG                  \
        "\x07" /**< desCBC OBJECT IDENTIFIER ::= { iso(1)                      \
                  identified-organization(3) oiw(14) secsig(3) algorithms(2) 7 \
                  } */
#define MBEDTLS_OID_DES_EDE3_CBC                                               \
    MBEDTLS_OID_RSA_COMPANY "\x03\x07" /**< des-ede3-cbc OBJECT IDENTIFIER ::= \
                                          { iso(1) member-body(2) -- us(840)   \
                                          rsadsi(113549)                       \
                                          encryptionAlgorithm(3) 7 } */
#define MBEDTLS_OID_AES                                                   \
    MBEDTLS_OID_NIST_ALG "\x01" /** aes OBJECT IDENTIFIER ::= {           \
                                   joint-iso-itu-t(2) country(16) us(840) \
                                   organization(1) gov(101) csor(3)       \
                                   nistAlgorithm(4) 1 } */
...
#define MBEDTLS_OID_AES128_KW                                                 \
    MBEDTLS_OID_AES "\x05" /** id-aes128-wrap     OBJECT IDENTIFIER ::= { aes \
                              5 } */
#define MBEDTLS_OID_AES128_KWP                                                \
    MBEDTLS_OID_AES "\x08" /** id-aes128-wrap-pad OBJECT IDENTIFIER ::= { aes \
                              8 } */
#define MBEDTLS_OID_AES192_KW                                                 \
    MBEDTLS_OID_AES "\x19" /** id-aes192-wrap     OBJECT IDENTIFIER ::= { aes \
                              25 } */
#define MBEDTLS_OID_AES192_KWP                                                \
    MBEDTLS_OID_AES "\x1c" /** id-aes192-wrap-pad OBJECT IDENTIFIER ::= { aes \
                              28 } */
#define MBEDTLS_OID_AES256_KW                                                 \
    MBEDTLS_OID_AES "\x2d" /** id-aes256-wrap     OBJECT IDENTIFIER ::= { aes \
                              45 } */
#define MBEDTLS_OID_AES256_KWP                                                \
    MBEDTLS_OID_AES "\x30" /** id-aes256-wrap-pad OBJECT IDENTIFIER ::= { aes \
                              48 } */
/*
 * PKCS#5 OIDs
 */
...
#define MBEDTLS_OID_PKCS5_PBE_MD5_DES_CBC                                    \
    MBEDTLS_OID_PKCS5 "\x03" /**< pbeWithMD5AndDES-CBC OBJECT IDENTIFIER ::= \
                                {pkcs-5 3} */
#define MBEDTLS_OID_PKCS5_PBE_MD5_RC2_CBC                                    \
    MBEDTLS_OID_PKCS5 "\x06" /**< pbeWithMD5AndRC2-CBC OBJECT IDENTIFIER ::= \
                                {pkcs-5 6} */
#define MBEDTLS_OID_PKCS5_PBE_SHA1_DES_CBC                                    \
    MBEDTLS_OID_PKCS5 "\x0a" /**< pbeWithSHA1AndDES-CBC OBJECT IDENTIFIER ::= \
                                {pkcs-5 10} */
#define MBEDTLS_OID_PKCS5_PBE_SHA1_RC2_CBC                                    \
    MBEDTLS_OID_PKCS5 "\x0b" /**< pbeWithSHA1AndRC2-CBC OBJECT IDENTIFIER ::= \
                                {pkcs-5 11} */
...
#define MBEDTLS_OID_PKCS9_CSR_EXT_REQ                                    \
    MBEDTLS_OID_PKCS9 "\x0e" /**< extensionRequest OBJECT IDENTIFIER ::= \
                                {pkcs-9 14} */
...
#define MBEDTLS_OID_PKCS12_PBE                                         \
    MBEDTLS_OID_PKCS12 "\x01" /**< pkcs-12PbeIds OBJECT IDENTIFIER ::= \
                                 {pkcs-12 1} */

#define MBEDTLS_OID_PKCS12_PBE_SHA1_DES3_EDE_CBC                              \
    MBEDTLS_OID_PKCS12_PBE "\x03" /**< pbeWithSHAAnd3-KeyTripleDES-CBC OBJECT \
                                     IDENTIFIER ::= {pkcs-12PbeIds 3} */
#define MBEDTLS_OID_PKCS12_PBE_SHA1_DES2_EDE_CBC                              \
    MBEDTLS_OID_PKCS12_PBE "\x04" /**< pbeWithSHAAnd2-KeyTripleDES-CBC OBJECT \
                                     IDENTIFIER ::= {pkcs-12PbeIds 4} */
#define MBEDTLS_OID_PKCS12_PBE_SHA1_RC2_128_CBC                          \
    MBEDTLS_OID_PKCS12_PBE "\x05" /**< pbeWithSHAAnd128BitRC2-CBC OBJECT \
                                     IDENTIFIER ::= {pkcs-12PbeIds 5} */
#define MBEDTLS_OID_PKCS12_PBE_SHA1_RC2_40_CBC                          \
    MBEDTLS_OID_PKCS12_PBE "\x06" /**< pbeWithSHAAnd40BitRC2-CBC OBJECT \
                                     IDENTIFIER ::= {pkcs-12PbeIds 6} */
