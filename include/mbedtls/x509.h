...
#define MBEDTLS_X509_BADCERT_CN_MISMATCH                               \
    0x04 /**< The certificate Common Name (CN) does not match with the \
            expected CN. */
...
#define MBEDTLS_X509_BADCERT_BAD_PK                                           \
    0x8000 /**< The certificate is signed with an unacceptable PK alg (eg RSA \
              vs ECDSA). */
#define MBEDTLS_X509_BADCERT_BAD_KEY                                         \
    0x010000 /**< The certificate is signed with an unacceptable key (eg bad \
                curve, RSA too short). */
#define MBEDTLS_X509_BADCRL_BAD_MD \
    0x020000 /**< The CRL is signed with an unacceptable hash. */
#define MBEDTLS_X509_BADCRL_BAD_PK                                         \
    0x040000 /**< The CRL is signed with an unacceptable PK alg (eg RSA vs \
                ECDSA). */
#define MBEDTLS_X509_BADCRL_BAD_KEY                                         \
    0x080000 /**< The CRL is signed with an unacceptable key (eg bad curve, \
                RSA too short). */
...
#define MBEDTLS_X509_MAX_DN_NAME_SIZE \
    256 /**< Maximum value size of a DN entry */
...
typedef struct mbedtls_x509_time {
    int MBEDTLS_PRIVATE(year), MBEDTLS_PRIVATE(mon), MBEDTLS_PRIVATE(day); /**<
                                                                              Date.
                                                                            */
    int MBEDTLS_PRIVATE(hour), MBEDTLS_PRIVATE(min), MBEDTLS_PRIVATE(sec); /**<
                                                                              Time.
                                                                            */
} mbedtls_x509_time;
